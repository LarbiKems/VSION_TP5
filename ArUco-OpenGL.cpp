...
void ArUco::drawScene() {
   ...
   if (m_Markers.size()==2){
	  ...
	  int distance =  m_Markers[1].pix
	  m_Markers[1].glGetModelViewMatrix(modelview_matrix1);
      glLoadMatrixd(modelview_matrix*modelview_matrix1);
	  glVertexLocal3d(0.0f,0.0f,0.0f);
